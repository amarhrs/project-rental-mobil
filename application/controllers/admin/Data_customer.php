...
class Data_customer extends CI_Controller
{
    ...
    {
        $data['customer'] = $this->R_model->get_data('customer')->result();
    ...
    public function update_customer_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->R_model->update_data('customer', $data, $where);
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    {
        $data['detail_customer'] = $this->R_model->ambil_id_customer($id);
    ...
    public function delete_customer($id)
    {
        ...
        $this->R_model->delete_data($where, 'customer');
