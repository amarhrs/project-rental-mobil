 ...
 <footer class="sticky-footer bg-white">
    ...
    <!-- Page level plugins -->
    <script src="<?php echo base_url('assets/assets_sbadmin') ?>/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?php echo base_url('assets/assets_sbadmin') ?>/js/demo/chart-area-demo.js"></script>
    <script src="<?php echo base_url('assets/assets_sbadmin') ?>/js/demo/chart-pie-demo.js"></script>
