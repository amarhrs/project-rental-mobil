						...
						<form method="POST" action="<?php echo base_url('admin/Data_mobil/update_mobil_aksi') ?>" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="form-group col-6">
									...
									<input type="text" value="<?php echo $mb->harga ?>" name="harga" id="harga" placeholder="ketik" autocomplete="off" class="form-control">
									<?php echo form_error('harga', '<div class="text-small text-danger">', '</div>') ?>
								</div>

								<div class="form-group col-6">
									<label for="denda">Denda</label>
									<input type="text" value="<?php echo $mb->denda ?>" name="denda" id="jumlah_kursi" placeholder="ketik" autocomplete="off" class="form-control">
