    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card" style="margin-top: 150px">
                ...
                <div class="card-body">
                    <p class="text-success mb-3">Silahkan Melakukan Pembyaran Melalui Nomor Rekening di Bawah Ini:</p>
                    ...
                    <?php } elseif ($tr->status_pembayaran == '0') { ?>
                        <button style="width: 100%" class="btn btn-sm btn-warning"><i class="bi bi-hourglass-split"></i>Menunggu Konfirmasi</button>
                    <?php } elseif ($tr->status_pembayaran == '1') { ?>
                        <button style="width: 100%" class="btn btn-sm btn-success"><i class="bi bi-check"></i>Pembayaran Selesai</button>
                    <?php } ?>
